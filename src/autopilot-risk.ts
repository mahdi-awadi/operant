...
export function wrapQuestion(rawQuestion: string, preferencesMarkdown: string): string {
  ...
  return [
    ...
    '- Be descriptive: explain WHICH option you chose and WHY in concrete terms,',
    '  citing the project context, the autopilot.md preferences, and any prior',
    '  decisions you can see in the conversation. State the rationale in full',
    '  sentences. Do not be terse — the user wants reasoning, not a one-word',
    '  answer.',
